...
RSpec.describe V1::MapsController, type: :controller do
  ...
  # V1::Map. As you add validations to V1::Map, be sure to
  ...
  # V1::MapsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new V1::Map" do
        expect {
          post :create, params: { v1_map: valid_attributes }, session: valid_session
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the new v1_map" do
        post :create, params: { v1_map: invalid_attributes }, session: valid_session
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested v1_map" do
        map = V1::Map.create! valid_attributes
        put :update, params: { id: map.to_param, v1_map: new_attributes }, session: valid_session
        map.reload
      ...
      it "renders a JSON response with the v1_map" do
        ...
        put :update, params: { id: map.to_param, v1_map: valid_attributes }, session: valid_session
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the v1_map" do
        ...
        put :update, params: { id: map.to_param, v1_map: invalid_attributes }, session: valid_session
        expect(response).to have_http_status(:unprocessable_entity)
        expect(response.content_type).to eq("application/json")
      end
    end
